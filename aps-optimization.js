(function () {
  ...
  function enhanceCollabPage() {
    ...
    const scheduleHistoryBtn = document.getElementById('aps-schedule-history-btn');
    ...
    if (scheduleHistoryBtn) {
      scheduleHistoryBtn.addEventListener('click', () => {
        window.location.href = 'schedule-history.html';
      });
    }
